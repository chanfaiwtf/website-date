<?php
	...
	//$username = "Eric";
	$query = 'update basic set hobby_lifestyle= "'.$lifestyle.'",hobby_sports="'.$sports.'",hobby_entertain="'.$entertain.'",hobby_eat="'.$eat.'" where user_name = "'.$username.'"';
	mysql_query($query , $db) or die(mysql_error($db));

	mysql_close();

	echo "<meta http-equiv='refresh' content='0;url=index-information.php'>";
